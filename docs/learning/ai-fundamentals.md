...
## 补充 · 华为AI通识：三要素、神经网络与算力

> 以下内容整理自《人工智能培训课件》，作为本阶段的**扩展补充**，帮助你把 AI 认知进一步落到「算法、数据、算力」与软硬件概览上。已在前面讲过的 AI/ML/DL、三大学习范式、训练/推理/微调、能力边界不再重复。
...
3. **Emerging（涌现）**：涌现能力出现在约 10^22 浮点运算（约 10B 参数）之后（Google 2023）。
