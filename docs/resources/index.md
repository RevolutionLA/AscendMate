...
| 你想要的 | 进入 |
| --- | --- |
| **所有链接**看一张总表 | [完整链接导航表](https://revolutionla.github.io/AscendMate/resources/links) |
| **样例代码与模型** | [样例代码与模型](https://revolutionla.github.io/AscendMate/resources/samples-models) |
| **软件/镜像下载** | [镜像与软件下载](https://revolutionla.github.io/AscendMate/resources/download) |

## 资源三大来源

- **官方文档**：[昇腾文档中心](https://www.hiascend.com/document)（CANN、PyTorch、MindIE 等）· [昇腾企业支持](https://support.huawei.com/enterprise/zh/ascend-computing)（硬件手册）。
